...
class Queries {
  ...
  static final String GET_APP_FROM_ID = "SELECT app_id, patient_name, patient_email, `jjag3/SurgeryAssistant`.`Appointments`.doctor, doctor_name, timeslot from `jjag3/SurgeryAssistant`.`Appointments`\n" +
  ...
  static final String GET_NAME = "SELECT patient_name from `jjag3/SurgeryAssistant`.`Patients` WHERE patient_id = ?";

  static final String ADD_LOG = "INSERT INTO `jjag3/SurgeryAssistant`.`Logs` VALUES(?, \"?\")";
